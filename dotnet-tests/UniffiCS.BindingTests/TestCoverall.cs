...
{
    [Fact]
    public void ObjectDecrementsHandle()
    {
        GC.Collect();
        Thread.Sleep(10);
    ...
    {
        var d = CoverallMethods.CreateSomeDict();
    ...
    {
        var coveralls = new Coveralls("test_arcs");
        ...
        Assert.Equal("test_arcs", coveralls.GetOther()!.GetName());
    ...
    {
        var coveralls = new Coveralls("test_return_objects");
        Assert.Equal(2UL, coveralls.StrongCount());

        var c2 = coveralls.CloneMe();
    ...
    {
        var coveralls = new Coveralls("test_simple_errors");
    ...
    {
        var coveralls = new Coveralls("test_complex_errors");
    ...
    {
        var coveralls = new Coveralls("test_interface_in_dicts");
    ...
    {
        var coveralls = new Coveralls("test_bytes");
